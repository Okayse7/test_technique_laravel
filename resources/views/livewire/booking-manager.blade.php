        ...
        <div class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div class="bg-white p-6 rounded shadow-lg w-full max-w-sm relative">
                ...
                <form wire:submit.prevent="submit" class="space-y-2">
                    <input type="text" wire:model="name" placeholder="Nom" class="border p-1 rounded w-full">
                    <label class="block text-sm font-medium text-gray-700 mt-2">Date de début</label>
